...
namespace DapperDino.DAL.Migrations
{
    ...
    [Migration("20190827043116_custombotforms")]
    partial class custombotforms
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DapperDino.DAL.Models.Forms.CustomBotForm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("CustomBotForms");
                });

            modelBuilder.Entity("DapperDino.DAL.Models.Forms.CustomBotFormReply", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DapperDino.DAL.Models.Forms.FormStatusUpdate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("FormStatusUpdates");
                });

            modelBuilder.Entity("DapperDino.DAL.Models.Forms.FormStatusUpdateStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("FormStatusUpdateStatuses");
                });
            ...
            modelBuilder.Entity("DapperDino.DAL.Models.Forms.CustomBotFormReply", b =>
                {
                    ...
                    b.HasOne("DapperDino.DAL.Models.Forms.CustomBotForm", "Form")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("DapperDino.DAL.Models.Forms.FormStatusUpdate", b =>
                {
                    ...
                    b.HasOne("DapperDino.DAL.Models.Forms.FormStatusUpdateStatus", "Status")
                        .WithMany()

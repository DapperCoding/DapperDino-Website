...
namespace DapperDino.DAL.Migrations
{
    ...
    [Migration("20190516231802_cascades-embed")]
    partial class cascadesembed
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DapperDino.DAL.Models.DiscordEmbed", b =>
                {
                    ...
                    b.HasIndex("FooterId")
                        .IsUnique()
                        .HasFilter("[FooterId] IS NOT NULL");
            ...
            modelBuilder.Entity("DapperDino.DAL.Models.DiscordEmbed", b =>
                {
                    b.HasOne("DapperDino.DAL.Models.DiscordEmbedAuthor", "Author")
                        .WithOne("DiscordEmbed")
                        .HasForeignKey("DapperDino.DAL.Models.DiscordEmbed", "AuthorId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("DapperDino.DAL.Models.DiscordColor", "Color")
                        .WithOne("DiscordEmbed")
                        .HasForeignKey("DapperDino.DAL.Models.DiscordEmbed", "ColorId")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.HasOne("DapperDino.DAL.Models.DiscordEmbedFooter", "Footer")
                        .WithOne("DiscordEmbed")
                        .HasForeignKey("DapperDino.DAL.Models.DiscordEmbed", "FooterId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("DapperDino.DAL.Models.DiscordEmbedImage", "Image")
                        .WithOne("DiscordEmbed")
                        .HasForeignKey("DapperDino.DAL.Models.DiscordEmbed", "ImageId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("DapperDino.DAL.Models.DiscordEmbedProvider", "Provider")
                        .WithOne("DiscordEmbed")
                        .HasForeignKey("DapperDino.DAL.Models.DiscordEmbed", "ProviderId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("DapperDino.DAL.Models.DiscordEmbedThumbnail", "Thumbnail")
                        .WithOne("DiscordEmbed")
                        .HasForeignKey("DapperDino.DAL.Models.DiscordEmbed", "ThumbnailId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("DapperDino.DAL.Models.DiscordEmbedVideo", "Video")
                        .WithOne("DiscordEmbed")
                        .HasForeignKey("DapperDino.DAL.Models.DiscordEmbed", "VideoId")
                        .OnDelete(DeleteBehavior.Cascade);
                });

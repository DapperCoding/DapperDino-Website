...
namespace DapperDino.Api.Controllers
{
    ...
    public class ArchitectFormController : FormBaseController
    {
        ...
        public ArchitectFormController(ApplicationDbContext context, UserManager<ApplicationUser> userManager,IConfiguration configuration, DiscordEmbedHelper discordEmbedHelper) : base(context, userManager)
        { 

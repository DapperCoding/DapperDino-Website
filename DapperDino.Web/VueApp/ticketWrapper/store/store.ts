...
import { Ticket, TicketReaction, TicketAction, DiscordUser } from '../types/models/ticket';
...
const actions: ActionTree<RootState, RootState> = {
    ...
    sendMessage({ commit }, message: string): Promise<boolean> {
        return new Promise((resolve, reject) => {
            try {
                axios
                    .post('/api/tickets/SendMessage', { message, ticketId: this.state.ticket.id })
                    .then(response => {
